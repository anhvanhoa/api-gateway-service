...
func GetServiceHandlers() map[string]ServiceHandler {
	return map[string]ServiceHandler{
		...
		"greenhouse_installation_log": ServiceHandler{
		...
		"growing_zone_history": ServiceHandler{
		...
		"iot_device_history": ServiceHandler{
		...
		"pest_disease_record": ServiceHandler{
		...
		"irrigation_schedule": ServiceHandler{
		...
		"fertilizer_type": ServiceHandler{
		...
		"fertilizer_schedule": ServiceHandler{
		...
		"maintenance_schedule": ServiceHandler{
		...
		"environmental_alert": ServiceHandler{
		...
		"system_configuration": ServiceHandler{
